...
- [Tilt-Corrected BF-STEM](https://doi.org/10.69761/XUNR2166)
- [Anisotropic 2D van der Waals Magnets Hosting 1D Spin Chains](https://doi.org/10.1002/adma.202401534)
...
- [Engineering Anomalously Large Electron Transport in Topological Semimetals](https://doi.org/10.1002/adma.202310944)
- [The Role of Optical Phonon Confinement in the Infrared Dielectric Response of III–V Superlattices](https://doi.org/10.1002/adma.202305106)

## 2023

- [Charge transport and hydrodynamics in materials](https://doi.org/10.1038/s41578-023-00597-3)
...
- [Mid- to Far-Infrared Anisotropic Dielectric Function of HfS2 and HfSe2](https://doi.org/10.1002/adom.202200933)
- [Generalized design principles for hydrodynamic electron transport in anisotropic metals](https://doi.org/10.1103/PhysRevMaterials.6.083802)
- [Probing Neuro-Endocrine Interactions Through Remote Magnetothermal Adrenal Stimulation](https://doi.org/10.3389/fnins.2022.901108)
- [Probing carrier interactions using electron hydrodynamics](https://doi.org/10.48550/arXiv.2204.06004)
- [Mesoscopic finite-size effects of unconventional electron transport in PdCoO2](https://doi.org/10.1103/PhysRevMaterials.6.045002)

## 2021

- [Imaging phonon-mediated hydrodynamic flow in WTe2](https://doi.org/10.1038/s41567-021-01341-w)
- [Capturing 3D atomic defects and phonon localization at the 2D heterostructure interface](https://doi.org/10.1126/sciadv.abi6699)
- [Anisotropic phonon-mediated electronic transport in chiral Weyl semimetals](https://doi.org/10.1103/PhysRevMaterials.5.L091202)
- [Sondheimer oscillations as a probe of non-ohmic flow in WP2 crystals](https://doi.org/10.1038/s41467-021-25037-0)
- [Influence of Magnetic Fields on Electrochemical Reactions of Redox Cofactor Solutions](https://doi.org/10.1002/ange.202106288)
- [Simulating Infiltration as a Sequence of Pinning and De-pinning Processes](https://doi.org/10.1016/j.actamat.2021.116831)
...
## 2019
- [Remotely controlled chemomagnetic modulation of targeted neural circuits](https://doi.org/10.1038/s41565-019-0521-z)
