...
:pronouns: he/him
:image: /images/team/WillemDeKleijne.webp
...
:pronouns: he/him
:image: /images/team/MathijsVanDenDoel.webp
:github: mathijsdoel
:email: m.j.j.vandendoel@tudelft.nl
:linkedin: mathijs-van-den-doel-b1bba5252
:reverse:

Mathijs completed his applied physics Bachelor End Project (BEP) in the Curious Beams Lab in December 2025, focusing on implementing higher-order corrections to the multislice formalism in the open-source simulation package [abTEM](https://github.com/abTEM/abTEM).
He is currently working on applying the principle of reciprocity to simulate partially coherent electron backscattered diffraction (EBSD) patterns.
